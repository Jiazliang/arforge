...
This directory contains focused ARForge example projects that highlight one capability at a time.
...
- `package_layout/` shows external ARXML package layout files, explicit per-element package assignment, and category-default package fallback.
...
Use `minimal/` when you want the simplest starter project.
Use these feature folders when you want to study one supported capability in more detail.
